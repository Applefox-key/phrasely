...
const aboutCards: AboutCard[] = [
  {
    ...
    title: 'ABOUT THE APP',
    short: [
      'This page <span>will help you remember</span> a new phrase or word using the 90 seconds technique.',
    ],
    long: [
    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-xs text-gray-400 dark:text-gray-500">
          ...
          <a href="https://flashcards.learnapp.pro" className="hover:text-teal-600 dark:hover:text-teal-400 underline">FlashMinds</a>
          {' · '}
          <a href="https://tracker.learnapp.pro" className="hover:text-teal-600 dark:hover:text-teal-400 underline">Tracker</a>
        </p>
      </div>
    </div>
  );
