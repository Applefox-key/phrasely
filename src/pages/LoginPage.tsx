    ...
    <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-8">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">Welcome back</h1>
            ...
            <button
              ...
              onClick={() => {
                window.location.href =
                  "https://api.learnapp.pro/users/auth/google?redirect=https://phrasely.learnapp.pro";
              }}
